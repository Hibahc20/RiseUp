                    ...
                    onPressed: () async {
                      ...
                      if(formKey.currentState!.validate())
                      {
                        ...
                        if(widget.category=="Merchant"){
                          ...
                          Map response= await MerchantRegister(username,txtEmail,password,chk);
                          if(response['success']==true){
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const MerchantCompleteProfile()),
                            );
                          }
                          else{
                            showDialog(
                          ...
                          bool chk2=true;
                          print(widget.category);
                          Map response= await DonorRegister(username,txtEmail,password,chk1,chk2);
                          if(response['success']==true){
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const DonorCompleteProfile()),
                            );
                          }
                          else{
                            showDialog(
...
Future<Map> MerchantRegister(String userName,String email, String pass, bool chk) async {
  var body = jsonEncode({
    'email': email,
    'userName': userName,
    'password': pass,
...
Future<Map> DonorRegister(String userName,String email, String pass, bool chk1,chk2) async {
  var body = jsonEncode({
    'email': email,
    'username': userName,
    'password': pass,
