...
import 'package:rise_up/CommonPages/SignUpToFillScreen.dart';
    ...
    return  Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding:EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.height*0.03,0,MediaQuery.of(context).size.width*0.03),
            child: Center(
                child: SizedBox(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: TextButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>  SignUpToFillScreen(category: 'Donor')),
                      );
                    },
                    child:  Text(
